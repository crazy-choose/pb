...
const uint32_t TableStruct_any_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_any_2eproto = {
  false, false, 189, descriptor_table_protodef_any_2eproto, "any.proto", 
  &descriptor_table_any_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_any_2eproto::offsets,
  file_level_metadata_any_2eproto, file_level_enum_descriptors_any_2eproto, file_level_service_descriptors_any_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_any_2eproto_getter() {
  return &descriptor_table_any_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_any_2eproto(&descriptor_table_any_2eproto);
namespace google {
namespace protobuf {
