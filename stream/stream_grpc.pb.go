...
type GreeterClient interface {
	...
	GetStream(ctx context.Context, in *model.StreamReqData, opts ...grpc.CallOption) (Greeter_GetStreamClient, error)
...
func (c *greeterClient) GetStream(ctx context.Context, in *model.StreamReqData, opts ...grpc.CallOption) (Greeter_GetStreamClient, error) {
...
type Greeter_GetStreamClient interface {
	Recv() (*model.StreamResData, error)
	grpc.ClientStream
}
...
func (x *greeterGetStreamClient) Recv() (*model.StreamResData, error) {
	m := new(model.StreamResData)
...
type Greeter_PutStreamClient interface {
	Send(*model.StreamReqData) error
	CloseAndRecv() (*model.StreamResData, error)
	grpc.ClientStream
}
...
func (x *greeterPutStreamClient) Send(m *model.StreamReqData) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greeterPutStreamClient) CloseAndRecv() (*model.StreamResData, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(model.StreamResData)
...
func (x *greeterAllStreamClient) Send(m *model.StreamReqData) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greeterAllStreamClient) Recv() (*model.StreamResData, error) {
	m := new(model.StreamResData)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreeterServer interface {
	...
	//服务端推送 客户端 rpc PutStream
	//客户端与 服务端 互相 推送 rpc AllStream
	GetStream(*model.StreamReqData, Greeter_GetStreamServer) error
...
func (UnimplementedGreeterServer) GetStream(*model.StreamReqData, Greeter_GetStreamServer) error {
...
type Greeter_GetStreamServer interface {
	Send(*model.StreamResData) error
	grpc.ServerStream
}
...
func (x *greeterGetStreamServer) Send(m *model.StreamResData) error {
...
type Greeter_PutStreamServer interface {
	SendAndClose(*model.StreamResData) error
	Recv() (*model.StreamReqData, error)
	grpc.ServerStream
}
...
func (x *greeterPutStreamServer) SendAndClose(m *model.StreamResData) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greeterPutStreamServer) Recv() (*model.StreamReqData, error) {
	m := new(model.StreamReqData)
...
func (x *greeterAllStreamServer) Send(m *model.StreamResData) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greeterAllStreamServer) Recv() (*model.StreamReqData, error) {
	m := new(model.StreamReqData)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
